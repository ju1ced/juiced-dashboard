/*! Juiced Dashboard 0.2.0-beta.2 | MIT License | https://github.com/ju1ced/juiced-dashboard */
var ye=["buiten","gelijkvloers","boven"],qe={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"};function s(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ue=new Set(["unavailable","unknown"]);function g(t){return t==null||Ue.has(t)}function u(t,e){return!e||!t?null:t.states?.[e]||null}function _(t,e){let i=Number(t);return Number.isFinite(i)?i.toFixed(e??1).replace(".",","):null}function y(t,e){let i=_(t,e);return i===null?null:`${i}\xB0`}var Ge={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",fan_only:"Ventilator",dry:"Droog"};function ve(t){let e=String(t??"").replace(/_/g," ");return e?e.charAt(0).toUpperCase()+e.slice(1):""}function S(t){return t&&(Ge[t]||ve(t))||"Onbekend"}function be(t){if(!t)return null;let e=t.attributes?.current_position;return typeof e=="number"&&Number.isFinite(e)?Math.round(e):t.state==="open"?100:t.state==="closed"?0:null}function _e(t){let e=be(t);return e===null?"\u2014":`${e}%`}function $(t,e,i){if(t)return t;let r=e?.attributes?.friendly_name;return typeof r=="string"&&r?r:i||""}function xe(t){let e=[],i=r=>{typeof r=="string"&&r.includes(".")&&e.push(r)};return i(t?.temperature),i(t?.humidity),i(t?.media_player),i(t?.climate),(t?.lights||[]).forEach(r=>i(r?.entity)),(t?.covers||[]).forEach(r=>i(r?.entity)),(t?.awnings||[]).forEach(r=>i(r?.entity)),e}function je(t){let e=new Set;return(t?.rooms||[]).forEach(i=>{xe(i).forEach(r=>e.add(r))}),[...e]}function we(t,e,i){if(!t||!e)return!0;let r=t.states||{},a=e.states||{};for(let o of i){let n=r[o],d=a[o];if(!n||!d){if(n!==d)return!0;continue}if(n.state!==d.state||n.last_updated!==d.last_updated)return!0}return!1}function X(t,e){let i=[],r=u(t,e?.temperature);if(r&&!g(r.state)){let o=y(r.state,1);o&&i.push(o)}let a=u(t,e?.humidity);if(a&&!g(a.state)){let o=_(a.state,0);o&&i.push(`${o}%`)}return i.length?i.join(" \xB7 "):e?.idle_text||"Rustig"}function D(t,e){return(e?.lights||[]).filter(i=>u(t,i?.entity)?.state==="on").length}function ke(t,e){let i=D(t,e);return i<=0?null:i===1?"1 lamp aan":`${i} lampen aan`}function Fe(t){return!!((t?.lights||[]).length||(t?.covers||[]).length||(t?.awnings||[]).length||t?.media_player||t?.climate)}function x(t,e,i,r,a){!t||!r||t.callService(e,i,{entity_id:r,...a||{}})}function M(t,e){x(t,"light","toggle",e)}function z(t,e){x(t,"cover","open_cover",e)}function I(t,e){x(t,"cover","close_cover",e)}function O(t,e){x(t,"cover","stop_cover",e)}function J(t,e,i){x(t,"climate","set_hvac_mode",e,{hvac_mode:i})}var Ce=20;function N(t,e,i,r){let o=i!==""&&i!==null&&i!==void 0?Number(i):NaN,n=Number.isFinite(o)?o:Ce,d=Math.round((n+r)*10)/10;x(t,"climate","set_temperature",e,{temperature:d})}function V(t,e){x(t,"media_player","media_play_pause",e)}function B(t,e){let i=e.lights||[];return i.length?`<div class="jrc-section"><h4>Verlichting</h4>${i.map(a=>{let o=u(t,a.entity),n=o?.state==="on",d=$(a.name,o,a.entity),c=g(o?.state);return`
        ...
        <div class="jrc-coverrow">
          ...
          <span class="jrc-cr-pos">${_e(d)}</span>
...
`;function ne(){typeof customElements>"u"||(customElements.get("juiced-dashboard-quick-actions")||customElements.define("juiced-dashboard-quick-actions",G),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-quick-actions")||window.customCards.push({type:"juiced-dashboard-quick-actions",name:"Juiced Dashboard \u2014 Snelacties",description:"Een kleine, gecureerde rij kruis-kamer acties (alarm, garagepoort, ...).",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ht=typeof HTMLElement>"u"?class{}:HTMLElement;function Tt(t,e){let i=[],r=u(t,e.temperature);if(r&&!g(r.state)){let n=y(r.state,1);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}</div><div class="jrd-tile-label">Temperatuur</div></div>`)}let a=u(t,e.humidity);if(a&&!g(a.state)){let n=_(a.state,0);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}<span class="jrd-tile-unit">%</span></div><div class="jrd-tile-label">Vochtigheid</div></div>`)}let o=e.lights||[];if(o.length>0){let n=D(t,e);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${n}<span class="jrd-tile-unit">/${o.length}</span></div><div class="jrd-tile-label">Lampen aan</div></div>`)}if(e.climate){let n=u(t,e.climate);if(n&&!g(n.state)){let d=y(n.attributes?.temperature,1);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(S(n.state))}</div><div class="jrd-tile-label">Klimaat${d?` \xB7 doel ${s(d)}`:""}</div></div>`)}}return i.length?`<div class="jrd-overview">${i.join("")}</div>`:""}var F=class extends Ht{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-room-detail-card",room:{name:"Bureau",icon:"mdi:desk"}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-room-detail-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 5}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_render(){if(!this._config)return;let e=this._config.room,i=this._hass,r=Tt(i,e),a=[P(i,e),B(i,e),k(i,e,"covers","Rolluiken"),k(i,e,"awnings","Luifels"),K(i,e)].filter(n=>!!n),o=r||a.length?`${r}${a.length?`<div class="jrd-sections">${a.join("")}</div>`:""}`:'<p class="jrd-empty">Geen bediening of sensoren geconfigureerd voor deze kamer.</p>';this.root.innerHTML=`
      ...
      </ha-card>`}_onClick(e){let r=e.target?.closest("[data-action]");if(!r)return;let a=r.dataset.action,o=this._hass;if(a==="toggle-light"){M(o,r.dataset.entity);return}if(a==="cover-open"){z(o,r.dataset.entity);return}if(a==="cover-close"){I(o,r.dataset.entity);return}if(a==="cover-stop"){O(o,r.dataset.entity);return}if(a==="media-toggle"){V(o,r.dataset.entity);return}if(a==="climate-mode"){J(o,r.dataset.entity,r.dataset.mode);return}if(a==="climate-step"){N(o,r.dataset.entity,r.dataset.target,Number(r.dataset.step));return}}},Dt=`
  :host { display: block; }
  * { box-sizing: border-box; }
  ha-card.jrd-shell {
    background: var(--juiced-surface-raised, var(--ha-card-background, var(--card-background-color, #fff)));
...
`;function ce(){typeof customElements>"u"||(customElements.get("juiced-dashboard-security-card")||customElements.define("juiced-dashboard-security-card",Q),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-security-card")||window.customCards.push({type:"juiced-dashboard-security-card",name:"Juiced Dashboard \u2014 Security",description:"Alarmbediening en een doorbladerbare camerastrook, privacy enkel bij camera's die dat effectief hebben.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ot=typeof HTMLElement>"u"?class{}:HTMLElement,Jt=[{key:"battery_soc_entity",label:"Thuisbatterij SoC"},{key:"battery_charge_entity",label:"Batterij laden"},{key:"battery_discharge_entity",label:"Batterij ontladen"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst"},{key:"home_consumption_entity",label:"Huisverbruik"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek"}];function Nt(t,e){let r=u(t,e)?.attributes?.unit_of_measurement;return typeof r=="string"?r:""}function Vt(t){return{"clear-night":"Helder",cloudy:"Bewolkt",exceptional:"Uitzonderlijk",fog:"Mist",hail:"Hagel",lightning:"Onweer","lightning-rainy":"Onweer met regen",partlycloudy:"Half bewolkt",pouring:"Zware regen",rainy:"Regenachtig",snowy:"Sneeuw","snowy-rainy":"Natte sneeuw",sunny:"Zonnig",windy:"Winderig","windy-variant":"Winderig"}[t]||t}var Bt=["zo","ma","di","wo","do","vr","za"];function Te(t){let e=t.match(/^(\d{1,2})-(\d{1,2})-(\d{4})$/);if(e)return new Date(Number(e[3]),Number(e[2])-1,Number(e[1]));let i=t.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/);if(i)return new Date(Number(i[1]),Number(i[2])-1,Number(i[3]));let r=new Date(t);return Number.isNaN(r.getTime())?null:r}function De(t,e=new Date){let i=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return Math.round((r.getTime()-i.getTime())/864e5)}function Me(t){return t===0?"Vandaag":t===1?"Morgen":t>1?`Over ${t} dagen`:t===-1?"Gisteren":`${Math.abs(t)} dagen geleden`}var W=class extends Ot{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"})}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-today-card",today:{weather_entity:"weather.thuis",waste_entities:[]}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-today-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 3}_render(){if(!this._config)return;let e=this._config.today??{waste_entities:[]},i=this._hass,r=this._weatherHtml(i,e.weather_entity),a=this._energyHtml(i,e),o=this._wasteHtml(i,e.waste_entities??[]);this.root.innerHTML=`
      ...
      <div class="jtc-weather">
        <div>
          <div class="jtc-weather-cond">${s(Vt(r.state))}</div>
          <div class="jtc-weather-loc">Thuis &middot; nu</div>
        </div>
        ${a?`<div class="jtc-weather-temp">${s(a)}</div>`:""}
      </div>`}_energyHtml(e,i){let r=Jt.map(a=>{let o=i[a.key],n=u(e,o);if(!o||!n||g(n.state))return"";let d=_(n.state,1);if(d===null)return"";let c=Nt(e,o);return`
        <div class="jtc-tile">
          <div class="jtc-tile-value">${s(d)}${c?` <span class="jtc-tile-unit">${s(c)}</span>`:""}</div>
          <div class="jtc-tile-label">${s(a.label)}</div>
        </div>`}).join("");return r?`<div class="jtc-energy">${r}</div>`:""}_wasteHtml(e,i){let r=i.map(a=>{let o=u(e,a);if(!o||g(o.state))return"";let n=o.attributes?.friendly_name,d=typeof n=="string"&&n?n:a,c=Te(o.state),l=c===null?`<span class="jtc-waste-wd">${s(o.state)}</span>`:`<span class="jtc-waste-day">${c.getDate()}</span><span class="jtc-waste-wd">${Bt[c.getDay()]}</span>`,m=c===null?"":Me(De(c));return`
      ...
      <div class="jde-room">
        ...
        <label>Zone
          <select data-room="${e.key}" data-field="zone">
            ...
            ${A.map(i=>`<option value="${i}" ${e.zone===i?"selected":""}>${f(Xt[i])}</option>`).join("")}
          </select>
        </label>
        ${me.map(i=>`
          <label>${f(i.label)}
...
`;function ge(){typeof customElements>"u"||customElements.get("juiced-dashboard-strategy-editor")||customElements.define("juiced-dashboard-strategy-editor",Y)}var Pe=Object.freeze({name:"Juiced Dashboard",version:"0.2.0-beta.2"});typeof window<"u"&&(ee(),ge(),pe(),ae(),window.__JUICED_DASHBOARD_BUILD__=Pe,console.info("%c JUICED DASHBOARD %c "+Pe.version,"color: #081018; background: #5cc8ff; font-weight: 700; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #5cc8ff; background: #0f1115; font-weight: 700; padding: 2px 6px; border-radius: 0 4px 4px 0;"));export{L as CONFIG_SCHEMA_VERSION,Ce as DEFAULT_CLIMATE_TARGET,G as JuicedDashboardQuickActions,T as JuicedDashboardRoomCard,F as JuicedDashboardRoomDetailCard,Q as JuicedDashboardSecurityCard,U as JuicedDashboardStrategy,Y as JuicedDashboardStrategyEditor,W as JuicedDashboardTodayCard,Z as JuicedDashboardViewStrategy,A as ROOM_ZONES,ie as START_VIEWS,re as THEME_MODES,te as VIEW_PATHS,Pe as buildInfo,Oe as buildView,I as closeCover,je as collectEntityIds,C as compileConfig,q as compileRoomForCard,be as coverPosition,_e as coverPositionLabel,oe as createDefaultConfig,De as daysUntil,$ as displayName,u as entityState,s as escapeHtml,_ as formatNumber,y as formatTemp,we as hasRelevantChange,ve as humanize,S as hvacModeLabel,g as isUnavailable,z as openCover,Te as parseWasteDate,ge as registerJuicedDashboardEditor,ne as registerJuicedDashboardQuickActions,ee as registerJuicedDashboardRoomCard,se as registerJuicedDashboardRoomDetailCard,ce as registerJuicedDashboardSecurityCard,ae as registerJuicedDashboardStrategy,de as registerJuicedDashboardTodayCard,pe as registerJuicedDashboardViewStrategy,Me as relativeWasteLabel,xe as roomEntityIds,ke as roomFlag,Fe as roomHasControls,R as roomIconSvg,D as roomLightsOn,Le as roomPath,P as roomSectionClimate,k as roomSectionCovers,B as roomSectionLights,K as roomSectionMedia,X as roomStatLine,J as setHvacMode,N as stepClimateTarget,O as stopCover,M as toggleLight,V as toggleMediaPlayPause};
