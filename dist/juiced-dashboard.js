/*! Juiced Dashboard 0.2.0-beta.4 | MIT License | https://github.com/ju1ced/juiced-dashboard */
var ye=["buiten","gelijkvloers","boven"],qe={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"};function s(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ue=new Set(["unavailable","unknown"]);function g(t){return t==null||Ue.has(t)}function u(t,e){return!e||!t?null:t.states?.[e]||null}function b(t,e){let i=Number(t);return Number.isFinite(i)?i.toFixed(e??1).replace(".",","):null}function y(t,e){let i=b(t,e);return i===null?null:`${i}\xB0`}var Ge={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",fan_only:"Ventilator",dry:"Droog"};function ve(t){let e=String(t??"").replace(/_/g," ");return e?e.charAt(0).toUpperCase()+e.slice(1):""}function S(t){return t&&(Ge[t]||ve(t))||"Onbekend"}function be(t){if(!t)return null;let e=t.attributes?.current_position;return typeof e=="number"&&Number.isFinite(e)?Math.round(e):t.state==="open"?100:t.state==="closed"?0:null}function xe(t){let e=be(t);return e===null?"\u2014":`${e}%`}function $(t,e,i){if(t)return t;let r=e?.attributes?.friendly_name;return typeof r=="string"&&r?r:i||""}function _e(t){let e=[],i=r=>{typeof r=="string"&&r.includes(".")&&e.push(r)};return i(t?.temperature),i(t?.humidity),i(t?.media_player),i(t?.climate),(t?.lights||[]).forEach(r=>i(r?.entity)),(t?.covers||[]).forEach(r=>i(r?.entity)),(t?.awnings||[]).forEach(r=>i(r?.entity)),e}function je(t){let e=new Set;return(t?.rooms||[]).forEach(i=>{_e(i).forEach(r=>e.add(r))}),[...e]}function we(t,e,i){if(!t||!e)return!0;let r=t.states||{},o=e.states||{};for(let a of i){let n=r[a],d=o[a];if(!n||!d){if(n!==d)return!0;continue}if(n.state!==d.state||n.last_updated!==d.last_updated)return!0}return!1}function X(t,e){let i=[],r=u(t,e?.temperature);if(r&&!g(r.state)){let a=y(r.state,1);a&&i.push(a)}let o=u(t,e?.humidity);if(o&&!g(o.state)){let a=b(o.state,0);a&&i.push(`${a}%`)}return i.length?i.join(" \xB7 "):e?.idle_text||"Rustig"}function T(t,e){return(e?.lights||[]).filter(i=>u(t,i?.entity)?.state==="on").length}function ke(t,e){let i=T(t,e);return i<=0?null:i===1?"1 lamp aan":`${i} lampen aan`}function Fe(t){return!!((t?.lights||[]).length||(t?.covers||[]).length||(t?.awnings||[]).length||t?.media_player||t?.climate)}function x(t,e,i,r,o){!t||!r||t.callService(e,i,{entity_id:r,...o||{}})}function M(t,e){x(t,"light","toggle",e)}function z(t,e){x(t,"cover","open_cover",e)}function O(t,e){x(t,"cover","close_cover",e)}function I(t,e){x(t,"cover","stop_cover",e)}function J(t,e,i){x(t,"climate","set_hvac_mode",e,{hvac_mode:i})}var Ce=20;function N(t,e,i,r){let a=i!==""&&i!==null&&i!==void 0?Number(i):NaN,n=Number.isFinite(a)?a:Ce,d=Math.round((n+r)*10)/10;x(t,"climate","set_temperature",e,{temperature:d})}function V(t,e){x(t,"media_player","media_play_pause",e)}function B(t,e){let i=e.lights||[];return i.length?`<div class="jrc-section"><h4>Verlichting</h4>${i.map(o=>{let a=u(t,o.entity),n=a?.state==="on",d=$(o.name,a,o.entity),c=g(a?.state);return`
        ...
        </div>`}).join("")}</div>`:""}function k(t,e,i,r){let o=e[i]||[];if(!o.length)return"";let a=o.map(n=>{let d=u(t,n.entity),c=$(n.name,d,n.entity);return`
        ...
        </div>`}).join("");return`<div class="jrc-section"><h4>${s(r)}</h4>${a}</div>`}function K(t,e){if(!e.media_player)return"";let i=u(t,e.media_player),r=$(null,i,e.media_player),o=i?.attributes?.media_title,a=typeof o=="string"&&o?o:g(i?.state)?"Niet beschikbaar":"Uit",n=i?.state==="playing";return`
    ...
    </div>`}function P(t,e){if(!e.climate)return"";let i=u(t,e.climate),r=$(null,i,e.climate),o=i?.attributes?.hvac_modes,a=Array.isArray(o)?o.filter(E=>typeof E=="string"):[],n=i?.state,d=y(i?.attributes?.current_temperature,1),c=i?.attributes?.temperature,l=y(c,1)||"\u2014",m=Number(i?.attributes?.target_temp_step),w=Number.isFinite(m)&&m>0?m:.5,fe=a.map(E=>`
...
`;function ne(){typeof customElements>"u"||(customElements.get("juiced-dashboard-quick-actions")||customElements.define("juiced-dashboard-quick-actions",G),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-quick-actions")||window.customCards.push({type:"juiced-dashboard-quick-actions",name:"Juiced Dashboard \u2014 Snelacties",description:"Een kleine, gecureerde rij kruis-kamer acties (alarm, garagepoort, ...).",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ht=typeof HTMLElement>"u"?class{}:HTMLElement;function Dt(t,e){let i=[],r=u(t,e.temperature);if(r&&!g(r.state)){let n=y(r.state,1);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}</div><div class="jrd-tile-label">Temperatuur</div></div>`)}let o=u(t,e.humidity);if(o&&!g(o.state)){let n=b(o.state,0);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}<span class="jrd-tile-unit">%</span></div><div class="jrd-tile-label">Vochtigheid</div></div>`)}let a=e.lights||[];if(a.length>0){let n=T(t,e);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${n}<span class="jrd-tile-unit">/${a.length}</span></div><div class="jrd-tile-label">Lampen aan</div></div>`)}if(e.climate){let n=u(t,e.climate);if(n&&!g(n.state)){let d=y(n.attributes?.temperature,1);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(S(n.state))}</div><div class="jrd-tile-label">Klimaat${d?` \xB7 doel ${s(d)}`:""}</div></div>`)}}return i.length?`<div class="jrd-overview">${i.join("")}</div>`:""}var F=class extends Ht{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-room-detail-card",room:{name:"Bureau",icon:"mdi:desk"}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-room-detail-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 5}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_render(){if(!this._config)return;let e=this._config.room,i=this._hass,r=Dt(i,e),o=[P(i,e),B(i,e),k(i,e,"covers","Rolluiken"),k(i,e,"awnings","Luifels"),K(i,e)].filter(n=>!!n),a=r||o.length?`${r}${o.length?`<div class="jrd-sections">${o.join("")}</div>`:""}`:'<p class="jrd-empty">Geen bediening of sensoren geconfigureerd voor deze kamer.</p>';this.root.innerHTML=`
      <style>${Tt}</style>
      ...
      </ha-card>`}_onClick(e){let r=e.target?.closest("[data-action]");if(!r)return;let o=r.dataset.action,a=this._hass;if(o==="toggle-light"){M(a,r.dataset.entity);return}if(o==="cover-open"){z(a,r.dataset.entity);return}if(o==="cover-close"){O(a,r.dataset.entity);return}if(o==="cover-stop"){I(a,r.dataset.entity);return}if(o==="media-toggle"){V(a,r.dataset.entity);return}if(o==="climate-mode"){J(a,r.dataset.entity,r.dataset.mode);return}if(o==="climate-step"){N(a,r.dataset.entity,r.dataset.target,Number(r.dataset.step));return}}},Tt=`
  :host { display: block; }
  * { box-sizing: border-box; }
  ha-card.jrd-shell {
    background: var(--juiced-surface-raised, var(--ha-card-background, var(--card-background-color, #fff)));
...
`;function ce(){typeof customElements>"u"||(customElements.get("juiced-dashboard-security-card")||customElements.define("juiced-dashboard-security-card",Q),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-security-card")||window.customCards.push({type:"juiced-dashboard-security-card",name:"Juiced Dashboard \u2014 Security",description:"Alarmbediening en een doorbladerbare camerastrook, privacy enkel bij camera's die dat effectief hebben.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ot=typeof HTMLElement>"u"?class{}:HTMLElement,It=[{key:"battery_soc_entity",label:"Thuisbatterij SoC"},{key:"battery_charge_entity",label:"Batterij laden"},{key:"battery_discharge_entity",label:"Batterij ontladen"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst"},{key:"home_consumption_entity",label:"Huisverbruik"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek"}];function Jt(t,e){let r=u(t,e)?.attributes?.unit_of_measurement;return typeof r=="string"?r:""}function Nt(t){return{"clear-night":"Helder",cloudy:"Bewolkt",exceptional:"Uitzonderlijk",fog:"Mist",hail:"Hagel",lightning:"Onweer","lightning-rainy":"Onweer met regen",partlycloudy:"Half bewolkt",pouring:"Zware regen",rainy:"Regenachtig",snowy:"Sneeuw","snowy-rainy":"Natte sneeuw",sunny:"Zonnig",windy:"Winderig","windy-variant":"Winderig"}[t]||t}var Vt=["zo","ma","di","wo","do","vr","za"];function De(t){let e=t.match(/^(\d{1,2})-(\d{1,2})-(\d{4})$/);if(e)return new Date(Number(e[3]),Number(e[2])-1,Number(e[1]));let i=t.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/);if(i)return new Date(Number(i[1]),Number(i[2])-1,Number(i[3]));let r=new Date(t);return Number.isNaN(r.getTime())?null:r}function Te(t,e=new Date){let i=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return Math.round((r.getTime()-i.getTime())/864e5)}function Me(t){return t===0?"Vandaag":t===1?"Morgen":t>1?`Over ${t} dagen`:t===-1?"Gisteren":`${Math.abs(t)} dagen geleden`}var W=class extends Ot{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"})}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-today-card",today:{weather_entity:"weather.thuis",waste_entities:[]}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-today-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 3}_render(){if(!this._config)return;let e=this._config.today??{waste_entities:[]},i=this._hass,r=this._weatherHtml(i,e.weather_entity),o=this._energyHtml(i,e),a=this._wasteHtml(i,e.waste_entities??[]);this.root.innerHTML=`
      ...
      <ha-card class="jtc-shell">
        ...
        ${o}
        ${a}
      </ha-card>`}_weatherHtml(e,i){let r=u(e,i);if(!i||!r||g(r.state))return"";let o=y(r.attributes?.temperature,1);return`
      ...
      </div>`}_energyHtml(e,i){let r=It.map(o=>{let a=i[o.key],n=u(e,a);if(!a||!n||g(n.state))return"";let d=b(n.state,1);if(d===null)return"";let c=Jt(e,a);return`
        <div class="jtc-tile">
          <div class="jtc-tile-value">${s(d)}${c?` <span class="jtc-tile-unit">${s(c)}</span>`:""}</div>
          <div class="jtc-tile-label">${s(o.label)}</div>
        </div>`}).join("");return r?`<div class="jtc-energy">${r}</div>`:""}_wasteHtml(e,i){let r=i.map(o=>{let a=u(e,o);if(!a||g(a.state))return"";let n=a.attributes?.friendly_name,d=typeof n=="string"&&n?n:o,c=De(a.state),l=c===null?`<span class="jtc-waste-wd">${s(a.state)}</span>`:`<span class="jtc-waste-day">${c.getDate()}</span><span class="jtc-waste-wd">${Vt[c.getDay()]}</span>`,m=c===null?"":Me(Te(c));return`
