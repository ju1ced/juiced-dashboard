...
var me=["buiten","gelijkvloers","boven"],Be={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"};function s(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ke=new Set(["unavailable","unknown"]);function p(t){return t==null||Ke.has(t)}function l(t,e){return!e||!t?null:t.states?.[e]||null}function y(t,e){let r=Number(t);return Number.isFinite(r)?r.toFixed(e??1).replace(".",","):null}function h(t,e){let r=y(t,e);return r===null?null:`${r}\xB0`}var Pe={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",fan_only:"Ventilator",dry:"Droog"};function ge(t){let e=String(t??"").replace(/_/g," ");return e?e.charAt(0).toUpperCase()+e.slice(1):""}function k(t){return t&&(Pe[t]||ge(t))||"Onbekend"}function fe(t){if(!t)return null;let e=t.attributes?.current_position;return typeof e=="number"&&Number.isFinite(e)?Math.round(e):t.state==="open"?100:t.state==="closed"?0:null}function he(t){let e=fe(t);return e===null?"\u2014":`${e}%`}function E(t,e,r){if(t)return t;let i=e?.attributes?.friendly_name;return typeof i=="string"&&i?i:r||""}function ye(t){let e=[],r=i=>{typeof i=="string"&&i.includes(".")&&e.push(i)};return r(t?.temperature),r(t?.humidity),r(t?.media_player),r(t?.climate),(t?.lights||[]).forEach(i=>r(i?.entity)),(t?.covers||[]).forEach(i=>r(i?.entity)),(t?.awnings||[]).forEach(i=>r(i?.entity)),e}function ve(t){let e=new Set;return(t?.rooms||[]).forEach(r=>{ye(r).forEach(i=>e.add(i))}),[...e]}function be(t,e,r){if(!t||!e)return!0;let i=t.states||{},o=e.states||{};for(let a of r){let n=i[a],c=o[a];if(!n||!c){if(n!==c)return!0;continue}if(n.state!==c.state||n.last_updated!==c.last_updated)return!0}return!1}function W(t,e){let r=[],i=l(t,e?.temperature);if(i&&!p(i.state)){let a=h(i.state,1);a&&r.push(a)}let o=l(t,e?.humidity);if(o&&!p(o.state)){let a=y(o.state,0);a&&r.push(`${a}%`)}return r.length?r.join(" \xB7 "):e?.idle_text||"Rustig"}function A(t,e){return(e?.lights||[]).filter(r=>l(t,r?.entity)?.state==="on").length}function xe(t,e){let r=A(t,e);return r<=0?null:r===1?"1 lamp aan":`${r} lampen aan`}function qe(t){return!!((t?.lights||[]).length||(t?.covers||[]).length||(t?.awnings||[]).length||t?.media_player||t?.climate)}function v(t,e,r,i,o){!t||!i||t.callService(e,r,{entity_id:i,...o||{}})}function T(t,e){v(t,"light","toggle",e)}function H(t,e){v(t,"cover","open_cover",e)}function D(t,e){v(t,"cover","close_cover",e)}function M(t,e){v(t,"cover","stop_cover",e)}function z(t,e,r){v(t,"climate","set_hvac_mode",e,{hvac_mode:r})}var _e=20;function O(t,e,r,i){let a=r!==""&&r!==null&&r!==void 0?Number(r):NaN,n=Number.isFinite(a)?a:_e,c=Math.round((n+i)*10)/10;v(t,"climate","set_temperature",e,{temperature:c})}function I(t,e){v(t,"media_player","media_play_pause",e)}function J(t,e){let r=e.lights||[];return r.length?`<div class="jrc-section"><h4>Verlichting</h4>${r.map(o=>{let a=l(t,o.entity),n=a?.state==="on",c=E(o.name,a,o.entity),d=p(a?.state);return`
        <div class="jrc-lightrow${n?" on":""}">
          <span class="jrc-lrow-ic">${je}</span>
        ...
        <div class="jrc-coverrow">
          ...
          <span class="jrc-cr-pos">${he(c)}</span>
        ...
        </div>`}).join("");return`<div class="jrc-section"><h4>${s(i)}</h4>${a}</div>`}function N(t,e){if(!e.media_player)return"";let r=l(t,e.media_player),i=E(null,r,e.media_player),o=r?.attributes?.media_title,a=typeof o=="string"&&o?o:p(r?.state)?"Niet beschikbaar":"Uit",n=r?.state==="playing";return`
    ...
    <div class="jrc-section">
      ...
      </div>`}_renderList(){let e=this.root.getElementById("list");if(!e)return;let r=this._hass,i=this._config?.rooms||[];if(!i.some(n=>n.zone)){e.innerHTML=`<div class="jrc-zone-grid">${i.map((n,c)=>this._roomRowHtml(n,c,r)).join("")}</div>`;return}let o=me.map(n=>({label:Be[n],indices:[]})),a={label:"Overige",indices:[]};i.forEach((n,c)=>{let d=me.indexOf(n.zone??"");(d>=0?o[d]:a).indices.push(c)}),e.innerHTML=[...o,a].filter(n=>n.indices.length>0).map(n=>`
          <div class="jrc-zone">
            <h3 class="jrc-zone-title">${s(n.label)}</h3>
            <div class="jrc-zone-grid">${n.indices.map(c=>this._roomRowHtml(i[c],c,r)).join("")}</div>
          </div>`).join("")}_roomRowHtml(e,r,i){let o=W(i,e),a=xe(i,e),n=(e.lights||[])[0],c=n?l(i,n.entity)?.state==="on":!1;return`
...
`;function Z(){typeof customElements<"u"&&(customElements.get("juiced-dashboard-room-card")||customElements.define("juiced-dashboard-room-card",L)),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-room-card")||window.customCards.push({type:"juiced-dashboard-room-card",name:"Juiced Dashboard Room Card",description:"Tik een kamer, krijg een popup met enkel wat daar bedienbaar is \u2014 lichten, rolluiken, luifels, radio, airco.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"}))}var S=1,Y=["home","rooms","energy","domains","more"],X=["home","rooms"],ee=["system","light","dark"],R=["buiten","gelijkvloers","boven"];function te(){return{type:"custom:juiced-dashboard",schema_version:1,general:{title:"Juiced Dashboard",start_view:"home",theme_mode:"system",person_entities:[]},today:{waste_entities:[]},quick_actions:[],security:{cameras:[]},rooms:[]}}function b(t){return typeof t=="object"&&t!==null}function $(t,e){return typeof t=="string"&&t?t:e}function u(t){return typeof t=="string"&&t?t:void 0}function rt(t,e){return typeof t=="string"&&X.includes(t)?t:e}function it(t,e){return typeof t=="string"&&ee.includes(t)?t:e}function ot(t){return typeof t=="string"&&R.includes(t)?t:void 0}var we=0;function at(){return we+=1,`room-${Date.now().toString(36)}-${we}`}function nt(t){let e=te().general;return b(t)?{title:$(t.title,e.title),start_view:rt(t.start_view,e.start_view),theme_mode:it(t.theme_mode,e.theme_mode),person_entities:Ee(t.person_entities)}:e}function st(t){if(!b(t))return null;let e=u(t.name);return e?{key:$(t.key,at()),name:e,icon:u(t.icon),zone:ot(t.zone),temperature_entity:u(t.temperature_entity),humidity_entity:u(t.humidity_entity),light_entity:u(t.light_entity),cover_entity:u(t.cover_entity),awning_entity:u(t.awning_entity),media_player_entity:u(t.media_player_entity),climate_entity:u(t.climate_entity)}:null}function Ee(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"&&e.length>0):[]}function ct(t){return b(t)?{weather_entity:u(t.weather_entity),battery_soc_entity:u(t.battery_soc_entity),battery_charge_entity:u(t.battery_charge_entity),battery_discharge_entity:u(t.battery_discharge_entity),solar_power_entity:u(t.solar_power_entity),home_consumption_entity:u(t.home_consumption_entity),monthly_peak_entity:u(t.monthly_peak_entity),waste_entities:Ee(t.waste_entities)}:{waste_entities:[]}}var ke=0;function dt(){return ke+=1,`action-${Date.now().toString(36)}-${ke}`}function lt(t){if(!b(t))return null;let e=u(t.entity),r=u(t.service);return!e||!r?null:{key:$(t.key,dt()),label:$(t.label,e),icon:u(t.icon),entity:e,service:r}}function ut(t){if(!Array.isArray(t))return[];let e=[];for(let r of t){let i=lt(r);i&&e.push(i)}return e}var Ce=0;function pt(){return Ce+=1,`camera-${Date.now().toString(36)}-${Ce}`}function mt(t){if(!b(t))return null;let e=u(t.name),r=u(t.camera_entity);return!e||!r?null:{key:$(t.key,pt()),name:e,camera_entity:r,privacy_entity:u(t.privacy_entity),privacy_service:u(t.privacy_service)}}function gt(t){if(!Array.isArray(t))return[];let e=[];for(let r of t){let i=mt(r);i&&e.push(i)}return e}function ft(t){return b(t)?{alarm_entity:u(t.alarm_entity),cameras:gt(t.cameras)}:{cameras:[]}}function ht(t){if(!Array.isArray(t))return[];let e=[];for(let r of t){let i=st(r);i&&e.push(i)}return e}function j(t){let e=b(t)?t:{};return{type:"custom:juiced-dashboard",schema_version:1,general:nt(e.general),today:ct(e.today),quick_actions:ut(e.quick_actions),security:ft(e.security),rooms:ht(e.rooms)}}function B(t){return{name:t.name,icon:t.icon,zone:t.zone,temperature:t.temperature_entity,humidity:t.humidity_entity,lights:t.light_entity?[{entity:t.light_entity}]:[],covers:t.cover_entity?[{entity:t.cover_entity}]:[],awnings:t.awning_entity?[{entity:t.awning_entity}]:[],media_player:t.media_player_entity,climate:t.climate_entity}}var yt=typeof HTMLElement>"u"?class{}:HTMLElement,vt={home:{title:"Home",icon:"mdi:home"},rooms:{title:"Kamers",icon:"mdi:floor-plan"},energy:{title:"Energie",icon:"mdi:lightning-bolt"},domains:{title:"Domeinen",icon:"mdi:view-grid-outline"},more:{title:"Meer",icon:"mdi:dots-horizontal-circle-outline"}};function Se(t){return`room-${t}`}function bt(t,e){let r=vt[t];return{title:r.title,path:t,icon:r.icon,subview:!1,strategy:{type:"custom:juiced-dashboard-view",view:t,general:e.general,today:e.today,quick_actions:e.quick_actions,security:e.security,rooms:e.rooms}}}function xt(t,e){return{title:t.name,path:Se(t.key),icon:t.icon||"mdi:sofa-outline",subview:!0,back_path:"rooms",strategy:{type:"custom:juiced-dashboard-view",view:"room",general:e.general,room:t}}}var K=class extends yt{static getCreateSuggestions(){return{title:"Juiced Dashboard",icon:"mdi:home-assistant"}}static getConfigElement(){return document.createElement("juiced-dashboard-strategy-editor")}static async generate(e){let r=j(e),i=[r.general.start_view,...Y.filter(o=>o!==r.general.start_view)];return{title:r.general.title,views:[...i.map(o=>bt(o,r)),...r.rooms.map(o=>xt(o,r))]}}};function re(){if(typeof customElements>"u"||typeof window>"u")return;let t="ll-strategy-dashboard-juiced-dashboard";customElements.get(t)||customElements.define(t,K),window.customStrategies??=[],window.customStrategies.some(e=>e.type==="juiced-dashboard"&&e.strategyType==="dashboard")||window.customStrategies.push({type:"juiced-dashboard",strategyType:"dashboard",name:"Juiced Dashboard",description:"Kia-ge\xEFnspireerd, GUI-geconfigureerd dashboard: Home, Kamers, Energie, Domeinen en Meer.",documentationURL:"https://github.com/ju1ced/juiced-dashboard"})}var _t=typeof HTMLElement>"u"?class{}:HTMLElement,jt='<svg viewBox="0 0 24 24" width="16" height="16"><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',wt=new Set(["on","open","armed_home","armed_away","armed_night","playing","heat","cool"]);function kt(t){return t.split(".")[0]??""}var P=class extends _t{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-quick-actions",actions:[]}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-quick-actions: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 1}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_onClick(e){let i=e.target?.closest("[data-entity]");if(!i||!this._hass)return;let o=i.dataset.entity,a=i.dataset.service;!o||!a||this._hass.callService(kt(o),a,{entity_id:o})}_render(){if(!this._config)return;let e=this._config.actions??[],r=this._hass;if(e.length===0){this.root.innerHTML=`<style>${Re}</style>`;return}let i=e.map(o=>{let a=l(r,o.entity),n=p(a?.state);return`
          ...
          </button>`}).join("");this.root.innerHTML=`<style>${Re}</style><div class="jqa-row">${i}</div>`}},Re=`
  :host { display: block; }
  * { box-sizing: border-box; }
...
`;function ie(){typeof customElements>"u"||(customElements.get("juiced-dashboard-quick-actions")||customElements.define("juiced-dashboard-quick-actions",P),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-quick-actions")||window.customCards.push({type:"juiced-dashboard-quick-actions",name:"Juiced Dashboard \u2014 Snelacties",description:"Een kleine, gecureerde rij kruis-kamer acties (alarm, garagepoort, ...).",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ct=typeof HTMLElement>"u"?class{}:HTMLElement;function Et(t,e){let r=[],i=l(t,e.temperature);if(i&&!p(i.state)){let n=h(i.state,1);n&&r.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}</div><div class="jrd-tile-label">Temperatuur</div></div>`)}let o=l(t,e.humidity);if(o&&!p(o.state)){let n=y(o.state,0);n&&r.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}<span class="jrd-tile-unit">%</span></div><div class="jrd-tile-label">Vochtigheid</div></div>`)}let a=e.lights||[];if(a.length>0){let n=A(t,e);r.push(`<div class="jrd-tile"><div class="jrd-tile-value">${n}<span class="jrd-tile-unit">/${a.length}</span></div><div class="jrd-tile-label">Lampen aan</div></div>`)}if(e.climate){let n=l(t,e.climate);if(n&&!p(n.state)){let c=h(n.attributes?.temperature,1);r.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(k(n.state))}</div><div class="jrd-tile-label">Klimaat${c?` \xB7 doel ${s(c)}`:""}</div></div>`)}}return r.length?`<div class="jrd-overview">${r.join("")}</div>`:""}var q=class extends Ct{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-room-detail-card",room:{name:"Bureau",icon:"mdi:desk"}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-room-detail-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 5}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_render(){if(!this._config)return;let e=this._config.room,r=this._hass,i=Et(r,e),o=[V(r,e),J(r,e),_(r,e,"covers","Rolluiken"),_(r,e,"awnings","Luifels"),N(r,e)].filter(n=>!!n),a=i||o.length?`${i}${o.length?`<div class="jrd-sections">${o.join("")}</div>`:""}`:'<p class="jrd-empty">Geen bediening of sensoren geconfigureerd voor deze kamer.</p>';this.root.innerHTML=`
      <style>${St}</style>
      ...
      </ha-card>`}_onClick(e){let i=e.target?.closest("[data-action]");if(!i)return;let o=i.dataset.action,a=this._hass;if(o==="toggle-light"){T(a,i.dataset.entity);return}if(o==="cover-open"){H(a,i.dataset.entity);return}if(o==="cover-close"){D(a,i.dataset.entity);return}if(o==="cover-stop"){M(a,i.dataset.entity);return}if(o==="media-toggle"){I(a,i.dataset.entity);return}if(o==="climate-mode"){z(a,i.dataset.entity,i.dataset.mode);return}if(o==="climate-step"){O(a,i.dataset.entity,i.dataset.target,Number(i.dataset.step));return}}},St=`
  :host { display: block; }
  * { box-sizing: border-box; }
  ha-card.jrd-shell {
    background: var(--juiced-surface-raised, var(--ha-card-background, var(--card-background-color, #fff)));
...
`;function ae(){typeof customElements>"u"||(customElements.get("juiced-dashboard-security-card")||customElements.define("juiced-dashboard-security-card",U),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-security-card")||window.customCards.push({type:"juiced-dashboard-security-card",name:"Juiced Dashboard \u2014 Security",description:"Alarmbediening en een doorbladerbare camerastrook, privacy enkel bij camera's die dat effectief hebben.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var At=typeof HTMLElement>"u"?class{}:HTMLElement,Tt=[{key:"battery_soc_entity",label:"Thuisbatterij SoC"},{key:"battery_charge_entity",label:"Batterij laden"},{key:"battery_discharge_entity",label:"Batterij ontladen"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst"},{key:"home_consumption_entity",label:"Huisverbruik"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek"}];function Ht(t,e){let i=l(t,e)?.attributes?.unit_of_measurement;return typeof i=="string"?i:""}function Dt(t){return{"clear-night":"Helder",cloudy:"Bewolkt",exceptional:"Uitzonderlijk",fog:"Mist",hail:"Hagel",lightning:"Onweer","lightning-rainy":"Onweer met regen",partlycloudy:"Half bewolkt",pouring:"Zware regen",rainy:"Regenachtig",snowy:"Sneeuw","snowy-rainy":"Natte sneeuw",sunny:"Zonnig",windy:"Winderig","windy-variant":"Winderig"}[t]||t}var Mt=["zo","ma","di","wo","do","vr","za"];function Le(t){let e=t.match(/^(\d{1,2})-(\d{1,2})-(\d{4})$/);if(e)return new Date(Number(e[3]),Number(e[2])-1,Number(e[1]));let r=t.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/);if(r)return new Date(Number(r[1]),Number(r[2])-1,Number(r[3]));let i=new Date(t);return Number.isNaN(i.getTime())?null:i}function Ae(t,e=new Date){let r=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=new Date(t.getFullYear(),t.getMonth(),t.getDate());return Math.round((i.getTime()-r.getTime())/864e5)}function Te(t){return t===0?"Vandaag":t===1?"Morgen":t>1?`Over ${t} dagen`:t===-1?"Gisteren":`${Math.abs(t)} dagen geleden`}var G=class extends At{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"})}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-today-card",today:{weather_entity:"weather.thuis",waste_entities:[]}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-today-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 3}_render(){if(!this._config)return;let e=this._config.today??{waste_entities:[]},r=this._hass,i=this._weatherHtml(r,e.weather_entity),o=this._energyHtml(r,e),a=this._wasteHtml(r,e.waste_entities??[]);this.root.innerHTML=`
      ...
      <div class="jtc-weather">
        <div>
          <div class="jtc-weather-cond">${s(Dt(i.state))}</div>
          <div class="jtc-weather-loc">Thuis &middot; nu</div>
        </div>
        ${o?`<div class="jtc-weather-temp">${s(o)}</div>`:""}
      </div>`}_energyHtml(e,r){let i=Tt.map(o=>{let a=r[o.key],n=l(e,a);if(!a||!n||p(n.state))return"";let c=y(n.state,1);if(c===null)return"";let d=Ht(e,a);return`
        <div class="jtc-tile">
          <div class="jtc-tile-value">${s(c)}${d?` <span class="jtc-tile-unit">${s(d)}</span>`:""}</div>
          <div class="jtc-tile-label">${s(o.label)}</div>
        </div>`}).join("");return i?`<div class="jtc-energy">${i}</div>`:""}_wasteHtml(e,r){let i=r.map(o=>{let a=l(e,o);if(!a||p(a.state))return"";let n=a.attributes?.friendly_name,c=typeof n=="string"&&n?n:o,d=Le(a.state),m=d===null?`<span class="jtc-waste-wd">${s(a.state)}</span>`:`<span class="jtc-waste-day">${d.getDate()}</span><span class="jtc-waste-wd">${Mt[d.getDay()]}</span>`,g=d===null?"":Te(Ae(d));return`
          <div class="jtc-waste-chip">
            <div class="jtc-waste-date">${m}</div>
            <div class="jtc-waste-text">
              <div class="jtc-waste-name">${s(c)}</div>
              ${g?`<div class="jtc-waste-value">${s(g)}</div>`:""}
            </div>
...
`;function ne(){typeof customElements>"u"||(customElements.get("juiced-dashboard-today-card")||customElements.define("juiced-dashboard-today-card",G),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-today-card")||window.customCards.push({type:"juiced-dashboard-today-card",name:"Juiced Dashboard \u2014 Vandaag",description:"Weer, energie-KPI's en afvalophaling in \xE9\xE9n rustige kaart.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ot=typeof HTMLElement>"u"?class{}:HTMLElement;function ce(t,e){return{type:"markdown",...e?{title:e}:{},content:t}}var He="Kamers",It="Tik een kamer om lichten, rolluiken, luifels, radio of airco direct te bedienen";function Jt(t){return t?!!(t.weather_entity||t.battery_soc_entity||t.battery_charge_entity||t.battery_discharge_entity||t.solar_power_entity||t.home_consumption_entity||t.monthly_peak_entity||(t.waste_entities??[]).length>0):!1}function Nt(t){if(Jt(t))return{type:"grid",cards:[{type:"custom:juiced-dashboard-today-card",today:t}]}}function Vt(t){if(!(!t||t.length===0))return{type:"grid",cards:[{type:"custom:juiced-dashboard-quick-actions",actions:t}]}}function Bt(t){return t?!!(t.alarm_entity||(t.cameras??[]).length>0):!1}function Kt(t){if(Bt(t))return{type:"grid",cards:[{type:"custom:juiced-dashboard-security-card",security:t}]}}function De(t){return t.length===0?{type:"grid",column_span:2,cards:[ce("Voeg kamers toe via **Dashboard bewerken \u2192 instellingen**.",He)]}:{type:"grid",column_span:2,cards:[{type:"custom:juiced-dashboard-room-card",title:He,subtitle:It,rooms:t.map(B)}]}}function Pt(t){let e=t?.person_entities??[];if(e.length)return e.map(r=>({type:"entity",entity:r,show_name:!0}))}function qt(t){return t?[{type:"grid",column_span:2,cards:[{type:"custom:juiced-dashboard-room-detail-card",room:B(t)}]}]:[{type:"grid",cards:[ce("Deze kamerconfiguratie ontbreekt.","Kamer")]}]}function se(t,e){return[{type:"grid",cards:[ce(e,t)]}]}function Me(t){let e;switch(t.view){case"home":e=[Nt(t.today),Kt(t.security),Vt(t.quick_actions),De(t.rooms??[])].filter(i=>!!i);break;case"rooms":e=[De(t.rooms??[])];break;case"room":e=qt(t.room);break;case"energy":e=se("Energie","Energie-overzicht volgt in een volgende stap.");break;case"domains":e=se("Domeinen","Specialistische domeinen (Kia, tuin, robotstofzuiger, zwembad) volgen in een volgende stap.");break;default:e=se("Meer","Instellingen en geschiedenis volgen in een volgende stap.");break}let r=t.view==="home"?Pt(t.general):void 0;return{type:"sections",max_columns:4,dense_section_placement:!0,sections:e,...r?{badges:r}:{}}}var F=class extends Ot{static async generate(e){return Me(e)}};function de(){if(ne(),ie(),ae(),oe(),typeof customElements>"u")return;let t="ll-strategy-view-juiced-dashboard-view";customElements.get(t)||customElements.define(t,F)}var Ut={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"},Gt=typeof HTMLElement>"u"?class{}:HTMLElement,ze=[{key:"temperature_entity",label:"Temperatuursensor",domain:"sensor"},{key:"humidity_entity",label:"Vochtigheidssensor",domain:"sensor"},{key:"light_entity",label:"Licht",domain:"light"},{key:"cover_entity",label:"Rolluik",domain:"cover"},{key:"awning_entity",label:"Luifel",domain:"cover"},{key:"media_player_entity",label:"Mediaspeler",domain:"media_player"},{key:"climate_entity",label:"Klimaat",domain:"climate"}],Oe=0,Ie=0,Je=0,Ne=[{key:"weather_entity",label:"Weerbron",domain:"weather"},{key:"battery_soc_entity",label:"Thuisbatterij SoC",domain:"sensor"},{key:"battery_charge_entity",label:"Batterij laden",domain:"sensor"},{key:"battery_discharge_entity",label:"Batterij ontladen",domain:"sensor"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst",domain:"sensor"},{key:"home_consumption_entity",label:"Huisverbruik",domain:"sensor"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek",domain:"sensor"}];function f(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Q=class extends Gt{_config;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._config=j(void 0),this._onInput=this._onInput.bind(this),this._onClick=this._onClick.bind(this),this._onSelectorChange=this._onSelectorChange.bind(this)}get root(){return this.shadowRoot}setConfig(e){this._config=j(e),this._render()}set hass(e){this._hass=e,this.root.querySelectorAll("ha-selector").forEach(r=>{r.hass=e})}get hass(){return this._hass}connectedCallback(){this.root.addEventListener("input",this._onInput),this.root.addEventListener("click",this._onClick),this.root.addEventListener("value-changed",this._onSelectorChange)}disconnectedCallback(){this.root.removeEventListener("input",this._onInput),this.root.removeEventListener("click",this._onClick),this.root.removeEventListener("value-changed",this._onSelectorChange)}_emit(){this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:this._config}}))}_updateGeneral(e,r){this._config={...this._config,general:{...this._config.general,[e]:r}},this._emit()}_updateRoom(e,r){this._config={...this._config,rooms:this._config.rooms.map(i=>i.key===e?{...i,...r}:i)},this._emit()}_addRoom(){Oe+=1;let e={key:`room-${Date.now().toString(36)}-${Oe}`,name:"Nieuwe kamer"};this._config={...this._config,rooms:[...this._config.rooms,e]},this._emit(),this._render()}_removeRoom(e){this._config={...this._config,rooms:this._config.rooms.filter(r=>r.key!==e)},this._emit(),this._render()}_updateToday(e){this._config={...this._config,today:{...this._config.today,...e}},this._emit()}_updateAction(e,r){this._config={...this._config,quick_actions:this._config.quick_actions.map(i=>i.key===e?{...i,...r}:i)},this._emit()}_addAction(){Ie+=1;let e={key:`action-${Date.now().toString(36)}-${Ie}`,label:"Nieuwe actie",entity:"",service:"toggle"};this._config={...this._config,quick_actions:[...this._config.quick_actions,e]},this._emit(),this._render()}_removeAction(e){this._config={...this._config,quick_actions:this._config.quick_actions.filter(r=>r.key!==e)},this._emit(),this._render()}_updateSecurity(e){this._config={...this._config,security:{...this._config.security,...e}},this._emit()}_updateCamera(e,r){this._config={...this._config,security:{...this._config.security,cameras:this._config.security.cameras.map(i=>i.key===e?{...i,...r}:i)}},this._emit()}_addCamera(){Je+=1;let e={key:`camera-${Date.now().toString(36)}-${Je}`,name:"Nieuwe camera",camera_entity:""};this._config={...this._config,security:{...this._config.security,cameras:[...this._config.security.cameras,e]}},this._emit(),this._render()}_removeCamera(e){this._config={...this._config,security:{...this._config.security,cameras:this._config.security.cameras.filter(r=>r.key!==e)}},this._emit(),this._render()}_onInput(e){let r=e.target;if(!r)return;let i=r.dataset.field;if(!i)return;if(r.dataset.scope==="general"){i==="title"&&this._updateGeneral("title",r.value),i==="start_view"&&this._updateGeneral("start_view",r.value),i==="theme_mode"&&this._updateGeneral("theme_mode",r.value);return}if(r.dataset.scope==="action"){let a=r.dataset.actionKey;if(!a)return;i==="label"&&this._updateAction(a,{label:r.value}),i==="icon"&&this._updateAction(a,{icon:r.value||void 0}),i==="service"&&this._updateAction(a,{service:r.value});return}if(r.dataset.scope==="camera"){let a=r.dataset.cameraKey;if(!a)return;i==="name"&&this._updateCamera(a,{name:r.value}),i==="privacy_service"&&this._updateCamera(a,{privacy_service:r.value||void 0});return}let o=r.dataset.room;o&&(i==="name"&&this._updateRoom(o,{name:r.value}),i==="icon"&&this._updateRoom(o,{icon:r.value||void 0}),i==="zone"&&this._updateRoom(o,{zone:r.value||void 0}))}_onSelectorChange(e){let r=e.target;if(!r||r.tagName.toLowerCase()!=="ha-selector")return;e.stopPropagation();let i=r.dataset.field,o=r.dataset.scope;if(!i)return;if(o==="general"){if(i==="person_entities"){let c=Array.isArray(e.detail?.value)?e.detail.value.filter(d=>typeof d=="string"):[];this._updateGeneral("person_entities",c)}return}if(o==="today"){if(i==="waste_entities"){let d=Array.isArray(e.detail?.value)?e.detail.value.filter(m=>typeof m=="string"):[];this._updateToday({waste_entities:d});return}let c=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateToday({[i]:c});return}if(o==="action"){let c=r.dataset.actionKey;if(!c)return;let d=typeof e.detail?.value=="string"?e.detail.value:"";this._updateAction(c,{entity:d});return}if(o==="security"){let c=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateSecurity({alarm_entity:c});return}if(o==="camera"){let c=r.dataset.cameraKey;if(!c)return;let d=typeof e.detail?.value=="string"?e.detail.value:void 0;i==="camera_entity"&&this._updateCamera(c,{camera_entity:d??""}),i==="privacy_entity"&&this._updateCamera(c,{privacy_entity:d});return}let a=r.dataset.room;if(!a)return;let n=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateRoom(a,{[i]:n})}_onClick(e){let r=e.target?.closest("[data-action]");r&&(r.dataset.action==="add-room"&&this._addRoom(),r.dataset.action==="remove-room"&&r.dataset.room&&this._removeRoom(r.dataset.room),r.dataset.action==="add-action"&&this._addAction(),r.dataset.action==="remove-action"&&r.dataset.actionKey&&this._removeAction(r.dataset.actionKey),r.dataset.action==="add-camera"&&this._addCamera(),r.dataset.action==="remove-camera"&&r.dataset.cameraKey&&this._removeCamera(r.dataset.cameraKey))}_render(){let e=this._config;this.root.innerHTML=`
      <style>${Ft}</style>
      ...
      <div class="jde-room">
        ...
        <label>Zone
          <select data-room="${e.key}" data-field="zone">
            ...
            ${R.map(r=>`<option value="${r}" ${e.zone===r?"selected":""}>${f(Ut[r])}</option>`).join("")}
          </select>
        </label>
        ${ze.map(r=>`
          <label>${f(r.label)}
...
`;function le(){typeof customElements>"u"||customElements.get("juiced-dashboard-strategy-editor")||customElements.define("juiced-dashboard-strategy-editor",Q)}var Ve=Object.freeze({name:"Juiced Dashboard",version:"0.1.0"});typeof window<"u"&&(Z(),le(),de(),re(),window.__JUICED_DASHBOARD_BUILD__=Ve,console.info("%c JUICED DASHBOARD %c "+Ve.version,"color: #081018; background: #5cc8ff; font-weight: 700; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #5cc8ff; background: #0f1115; font-weight: 700; padding: 2px 6px; border-radius: 0 4px 4px 0;"));export{S as CONFIG_SCHEMA_VERSION,_e as DEFAULT_CLIMATE_TARGET,P as JuicedDashboardQuickActions,L as JuicedDashboardRoomCard,q as JuicedDashboardRoomDetailCard,U as JuicedDashboardSecurityCard,K as JuicedDashboardStrategy,Q as JuicedDashboardStrategyEditor,G as JuicedDashboardTodayCard,F as JuicedDashboardViewStrategy,R as ROOM_ZONES,X as START_VIEWS,ee as THEME_MODES,Y as VIEW_PATHS,Ve as buildInfo,Me as buildView,D as closeCover,ve as collectEntityIds,j as compileConfig,B as compileRoomForCard,fe as coverPosition,he as coverPositionLabel,te as createDefaultConfig,Ae as daysUntil,E as displayName,l as entityState,s as escapeHtml,y as formatNumber,h as formatTemp,be as hasRelevantChange,ge as humanize,k as hvacModeLabel,p as isUnavailable,H as openCover,Le as parseWasteDate,le as registerJuicedDashboardEditor,ie as registerJuicedDashboardQuickActions,Z as registerJuicedDashboardRoomCard,oe as registerJuicedDashboardRoomDetailCard,ae as registerJuicedDashboardSecurityCard,re as registerJuicedDashboardStrategy,ne as registerJuicedDashboardTodayCard,de as registerJuicedDashboardViewStrategy,Te as relativeWasteLabel,ye as roomEntityIds,xe as roomFlag,qe as roomHasControls,C as roomIconSvg,A as roomLightsOn,Se as roomPath,V as roomSectionClimate,_ as roomSectionCovers,J as roomSectionLights,N as roomSectionMedia,W as roomStatLine,z as setHvacMode,O as stepClimateTarget,M as stopCover,T as toggleLight,I as toggleMediaPlayPause};
