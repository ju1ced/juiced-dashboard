...
var fe=["buiten","gelijkvloers","boven"],Ve={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"};function s(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Be=new Set(["unavailable","unknown"]);function g(t){return t==null||Be.has(t)}function u(t,e){return!e||!t?null:t.states?.[e]||null}function y(t,e){let i=Number(t);return Number.isFinite(i)?i.toFixed(e??1).replace(".",","):null}function h(t,e){let i=y(t,e);return i===null?null:`${i}\xB0`}var Ke={off:"Uit",heat:"Verwarmen",cool:"Koelen",heat_cool:"Auto",auto:"Auto",fan_only:"Ventilator",dry:"Droog"};function he(t){let e=String(t??"").replace(/_/g," ");return e?e.charAt(0).toUpperCase()+e.slice(1):""}function k(t){return t&&(Ke[t]||he(t))||"Onbekend"}function ye(t){if(!t)return null;let e=t.attributes?.current_position;return typeof e=="number"&&Number.isFinite(e)?Math.round(e):t.state==="open"?100:t.state==="closed"?0:null}function ve(t){let e=ye(t);return e===null?"\u2014":`${e}%`}function E(t,e,i){if(t)return t;let r=e?.attributes?.friendly_name;return typeof r=="string"&&r?r:i||""}function be(t){let e=[],i=r=>{typeof r=="string"&&r.includes(".")&&e.push(r)};return i(t?.temperature),i(t?.humidity),i(t?.media_player),i(t?.climate),(t?.lights||[]).forEach(r=>i(r?.entity)),(t?.covers||[]).forEach(r=>i(r?.entity)),(t?.awnings||[]).forEach(r=>i(r?.entity)),e}function xe(t){let e=new Set;return(t?.rooms||[]).forEach(i=>{be(i).forEach(r=>e.add(r))}),[...e]}function _e(t,e,i){if(!t||!e)return!0;let r=t.states||{},o=e.states||{};for(let a of i){let n=r[a],d=o[a];if(!n||!d){if(n!==d)return!0;continue}if(n.state!==d.state||n.last_updated!==d.last_updated)return!0}return!1}function Z(t,e){let i=[],r=u(t,e?.temperature);if(r&&!g(r.state)){let a=h(r.state,1);a&&i.push(a)}let o=u(t,e?.humidity);if(o&&!g(o.state)){let a=y(o.state,0);a&&i.push(`${a}%`)}return i.length?i.join(" \xB7 "):e?.idle_text||"Rustig"}function T(t,e){return(e?.lights||[]).filter(i=>u(t,i?.entity)?.state==="on").length}function je(t,e){let i=T(t,e);return i<=0?null:i===1?"1 lamp aan":`${i} lampen aan`}function Pe(t){return!!((t?.lights||[]).length||(t?.covers||[]).length||(t?.awnings||[]).length||t?.media_player||t?.climate)}function v(t,e,i,r,o){!t||!r||t.callService(e,i,{entity_id:r,...o||{}})}function H(t,e){v(t,"light","toggle",e)}function D(t,e){v(t,"cover","open_cover",e)}function M(t,e){v(t,"cover","close_cover",e)}function z(t,e){v(t,"cover","stop_cover",e)}function I(t,e,i){v(t,"climate","set_hvac_mode",e,{hvac_mode:i})}var we=20;function O(t,e,i,r){let a=i!==""&&i!==null&&i!==void 0?Number(i):NaN,n=Number.isFinite(a)?a:we,d=Math.round((n+r)*10)/10;v(t,"climate","set_temperature",e,{temperature:d})}function J(t,e){v(t,"media_player","media_play_pause",e)}function N(t,e){let i=e.lights||[];return i.length?`<div class="jrc-section"><h4>Verlichting</h4>${i.map(o=>{let a=u(t,o.entity),n=a?.state==="on",d=E(o.name,a,o.entity),c=g(a?.state);return`
        <div class="jrc-lightrow${n?" on":""}">
          <span class="jrc-lrow-ic">${Ue}</span>
        ...
        </div>`}).join("")}</div>`:""}function _(t,e,i,r){let o=e[i]||[];if(!o.length)return"";let a=o.map(n=>{let d=u(t,n.entity),c=E(n.name,d,n.entity);return`
        <div class="jrc-coverrow">
          <span class="jrc-cr-name">${s(c)}</span>
          <span class="jrc-cr-pos">${ve(d)}</span>
          <span class="jrc-cr-btns">
            <button data-action="cover-open" data-entity="${s(n.entity)}" aria-label="Omhoog">${Qe}</button>
            <button data-action="cover-stop" data-entity="${s(n.entity)}" aria-label="Stop">${Ze}</button>
            <button data-action="cover-close" data-entity="${s(n.entity)}" aria-label="Omlaag">${We}</button>
          </span>
        </div>`}).join("");return`<div class="jrc-section"><h4>${s(r)}</h4>${a}</div>`}function V(t,e){if(!e.media_player)return"";let i=u(t,e.media_player),r=E(null,i,e.media_player),o=i?.attributes?.media_title,a=typeof o=="string"&&o?o:g(i?.state)?"Niet beschikbaar":"Uit",n=i?.state==="playing";return`
    <div class="jrc-section">
      <h4>Media</h4>
      <div class="jrc-media">
        <span class="jrc-media-ic">${Ye}</span>
    ...
    <div class="jrc-section">
      ...
      <div class="jrc-row" role="button" tabindex="0" data-action="open-room" data-room="${i}">
        ...
        <span class="jrc-chev">${Ge}</span>
      </div>`}_openRoom(e){if(!(this._config?.rooms||[])[e])return;this._openRoomIndex=e,this._renderPopup(),this.root.getElementById("backdrop")?.classList.add("show"),typeof document<"u"&&document.addEventListener("keydown",this._onDocKeydown)}_closePopup(){this._openRoomIndex=null,this.root.getElementById("backdrop")?.classList.remove("show"),typeof document<"u"&&document.removeEventListener("keydown",this._onDocKeydown)}_renderPopup(){let e=(this._config?.rooms||[])[this._openRoomIndex];if(!e)return;let i=this._hass,r=this.root.getElementById("popup-icon");r&&(r.innerHTML=C(e.icon));let o=this.root.getElementById("popup-name");o&&(o.textContent=e.name);let a=this.root.getElementById("popup-sub");a&&(a.textContent=Z(i,e));let n=[N(i,e),_(i,e,"covers","Rolluiken"),_(i,e,"awnings","Luifels"),V(i,e),B(i,e)].filter(Boolean).join(""),d=this.root.getElementById("popup-body");d&&(d.innerHTML=n||'<p class="jrc-empty">Geen snelbediening geconfigureerd voor deze kamer.</p>')}_onClick(e){let r=e.target?.closest("[data-action]");if(!r)return;let o=r.dataset.action,a=this._hass;if(o==="open-room"){this._openRoom(Number(r.dataset.room));return}if(o==="close"||o==="close-backdrop"){if(o==="close-backdrop"&&e.target!==r)return;this._closePopup();return}if(o==="toggle-light"){e.stopPropagation(),H(a,r.dataset.entity);return}if(o==="cover-open"){D(a,r.dataset.entity);return}if(o==="cover-close"){M(a,r.dataset.entity);return}if(o==="cover-stop"){z(a,r.dataset.entity);return}if(o==="media-toggle"){J(a,r.dataset.entity);return}if(o==="climate-mode"){I(a,r.dataset.entity,r.dataset.mode);return}if(o==="climate-step"){O(a,r.dataset.entity,r.dataset.target,Number(r.dataset.step));return}}_onKeydown(e){if(e.key!=="Enter"&&e.key!==" ")return;let r=e.target?.closest('[data-action="open-room"]');r&&(e.preventDefault(),this._openRoom(Number(r.dataset.room)))}_onDocKeydown(e){e.key==="Escape"&&this._closePopup()}},Ue='<svg viewBox="0 0 24 24" width="16" height="16"><g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-3.4 10.9c.5.5.9 1.2 1 2h4.8c.1-.8.5-1.5 1-2A6 6 0 0 0 12 3z"/></g></svg>',Ge='<svg viewBox="0 0 24 24" width="15" height="15"><polyline points="9 6 15 12 9 18" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',Fe='<svg viewBox="0 0 24 24" width="15" height="15"><g stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></g></svg>',Qe='<svg viewBox="0 0 24 24" width="14" height="14"><polyline points="6 15 12 9 18 15" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/></svg>',We='<svg viewBox="0 0 24 24" width="14" height="14"><polyline points="6 9 12 15 18 9" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/></svg>',Ze='<svg viewBox="0 0 24 24" width="14" height="14"><rect x="7" y="7" width="10" height="10" rx="1.5" fill="currentColor"/></svg>',Ye='<svg viewBox="0 0 24 24" width="18" height="18"><g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="2" width="12" height="20" rx="3"/><circle cx="12" cy="8.2" r="2.4"/><circle cx="12" cy="16.5" r="1.1"/></g></svg>',Xe='<svg viewBox="0 0 24 24" width="13" height="13"><polygon points="6 4 20 12 6 20" fill="currentColor"/></svg>',et='<svg viewBox="0 0 24 24" width="17" height="17"><g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11l8-7 8 7"/><path d="M6 10v9h12v-9"/><path d="M10 19v-5h4v5"/></g></svg>';function C(t){return typeof t=="string"&&t.startsWith("mdi:")?`<ha-icon icon="${s(t)}"></ha-icon>`:et}var tt=`
  :host { display: block; }
...
`;function Y(){typeof customElements<"u"&&(customElements.get("juiced-dashboard-room-card")||customElements.define("juiced-dashboard-room-card",A)),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-room-card")||window.customCards.push({type:"juiced-dashboard-room-card",name:"Juiced Dashboard Room Card",description:"Tik een kamer, krijg een popup met enkel wat daar bedienbaar is \u2014 lichten, rolluiken, luifels, radio, airco.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"}))}var R=1,X=["home","rooms","energy","domains","more"],ee=["home","rooms"],te=["system","light","dark"],S=["buiten","gelijkvloers","boven"];function ie(){return{type:"custom:juiced-dashboard",schema_version:1,general:{title:"Juiced Dashboard",start_view:"home",theme_mode:"system",person_entities:[]},today:{waste_entities:[]},quick_actions:[],security:{cameras:[]},rooms:[]}}function b(t){return typeof t=="object"&&t!==null}function L(t,e){return typeof t=="string"&&t?t:e}function p(t){return typeof t=="string"&&t?t:void 0}function it(t,e){return typeof t=="string"&&ee.includes(t)?t:e}function rt(t,e){return typeof t=="string"&&te.includes(t)?t:e}function ot(t){return typeof t=="string"&&S.includes(t)?t:void 0}var ke=0;function at(){return ke+=1,`room-${Date.now().toString(36)}-${ke}`}function nt(t){let e=ie().general;return b(t)?{title:L(t.title,e.title),start_view:it(t.start_view,e.start_view),theme_mode:rt(t.theme_mode,e.theme_mode),person_entities:$(t.person_entities)}:e}function st(t){if(!b(t))return null;let e=p(t.name);return e?{key:L(t.key,at()),name:e,icon:p(t.icon),zone:ot(t.zone),temperature_entity:p(t.temperature_entity),humidity_entity:p(t.humidity_entity),light_entities:$(t.light_entities),cover_entities:$(t.cover_entities),awning_entities:$(t.awning_entities),media_player_entity:p(t.media_player_entity),climate_entity:p(t.climate_entity)}:null}function $(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"&&e.length>0):[]}function ct(t){return b(t)?{weather_entity:p(t.weather_entity),battery_soc_entity:p(t.battery_soc_entity),battery_charge_entity:p(t.battery_charge_entity),battery_discharge_entity:p(t.battery_discharge_entity),solar_power_entity:p(t.solar_power_entity),home_consumption_entity:p(t.home_consumption_entity),monthly_peak_entity:p(t.monthly_peak_entity),waste_entities:$(t.waste_entities)}:{waste_entities:[]}}var Ce=0;function dt(){return Ce+=1,`action-${Date.now().toString(36)}-${Ce}`}function lt(t){if(!b(t))return null;let e=p(t.entity),i=p(t.service);return!e||!i?null:{key:L(t.key,dt()),label:L(t.label,e),icon:p(t.icon),entity:e,service:i}}function ut(t){if(!Array.isArray(t))return[];let e=[];for(let i of t){let r=lt(i);r&&e.push(r)}return e}var Ee=0;function pt(){return Ee+=1,`camera-${Date.now().toString(36)}-${Ee}`}function mt(t){if(!b(t))return null;let e=p(t.name),i=p(t.camera_entity);return!e||!i?null:{key:L(t.key,pt()),name:e,camera_entity:i,privacy_entity:p(t.privacy_entity),privacy_service:p(t.privacy_service)}}function gt(t){if(!Array.isArray(t))return[];let e=[];for(let i of t){let r=mt(i);r&&e.push(r)}return e}function ft(t){return b(t)?{alarm_entity:p(t.alarm_entity),cameras:gt(t.cameras)}:{cameras:[]}}function ht(t){if(!Array.isArray(t))return[];let e=[];for(let i of t){let r=st(i);r&&e.push(r)}return e}function j(t){let e=b(t)?t:{};return{type:"custom:juiced-dashboard",schema_version:1,general:nt(e.general),today:ct(e.today),quick_actions:ut(e.quick_actions),security:ft(e.security),rooms:ht(e.rooms)}}function K(t){return{name:t.name,icon:t.icon,zone:t.zone,temperature:t.temperature_entity,humidity:t.humidity_entity,lights:(t.light_entities??[]).map(e=>({entity:e})),covers:(t.cover_entities??[]).map(e=>({entity:e})),awnings:(t.awning_entities??[]).map(e=>({entity:e})),media_player:t.media_player_entity,climate:t.climate_entity}}var yt=typeof HTMLElement>"u"?class{}:HTMLElement,vt={home:{title:"Home",icon:"mdi:home"},rooms:{title:"Kamers",icon:"mdi:floor-plan"},energy:{title:"Energie",icon:"mdi:lightning-bolt"},domains:{title:"Domeinen",icon:"mdi:view-grid-outline"},more:{title:"Meer",icon:"mdi:dots-horizontal-circle-outline"}};function Re(t){return`room-${t}`}function bt(t,e){let i=vt[t];return{title:i.title,path:t,icon:i.icon,subview:!1,strategy:{type:"custom:juiced-dashboard-view",view:t,general:e.general,today:e.today,quick_actions:e.quick_actions,security:e.security,rooms:e.rooms}}}function xt(t,e){return{title:t.name,path:Re(t.key),icon:t.icon||"mdi:sofa-outline",subview:!0,back_path:"rooms",strategy:{type:"custom:juiced-dashboard-view",view:"room",general:e.general,room:t}}}var P=class extends yt{static getCreateSuggestions(){return{title:"Juiced Dashboard",icon:"mdi:home-assistant"}}static getConfigElement(){return document.createElement("juiced-dashboard-strategy-editor")}static async generate(e){let i=j(e),r=[i.general.start_view,...X.filter(o=>o!==i.general.start_view)];return{title:i.general.title,views:[...r.map(o=>bt(o,i)),...i.rooms.map(o=>xt(o,i))]}}};function re(){if(typeof customElements>"u"||typeof window>"u")return;let t="ll-strategy-dashboard-juiced-dashboard";customElements.get(t)||customElements.define(t,P),window.customStrategies??=[],window.customStrategies.some(e=>e.type==="juiced-dashboard"&&e.strategyType==="dashboard")||window.customStrategies.push({type:"juiced-dashboard",strategyType:"dashboard",name:"Juiced Dashboard",description:"Kia-ge\xEFnspireerd, GUI-geconfigureerd dashboard: Home, Kamers, Energie, Domeinen en Meer.",documentationURL:"https://github.com/ju1ced/juiced-dashboard"})}var _t=typeof HTMLElement>"u"?class{}:HTMLElement,jt='<svg viewBox="0 0 24 24" width="16" height="16"><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',wt=new Set(["on","open","armed_home","armed_away","armed_night","playing","heat","cool"]);function kt(t){return t.split(".")[0]??""}var q=class extends _t{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-quick-actions",actions:[]}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-quick-actions: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 1}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_onClick(e){let r=e.target?.closest("[data-entity]");if(!r||!this._hass)return;let o=r.dataset.entity,a=r.dataset.service;!o||!a||this._hass.callService(kt(o),a,{entity_id:o})}_render(){if(!this._config)return;let e=this._config.actions??[],i=this._hass;if(e.length===0){this.root.innerHTML=`<style>${Se}</style>`;return}let r=e.map(o=>{let a=u(i,o.entity),n=g(a?.state);return`
          <button class="jqa-chip${!!(a&&wt.has(a.state))?" on":""}" data-entity="${s(o.entity)}" data-service="${s(o.service)}" ${n?"disabled":""}>
            <span class="jqa-ic">${jt}</span>
            <span class="jqa-label">${s(o.label)}</span>
          </button>`}).join("");this.root.innerHTML=`<style>${Se}</style><div class="jqa-row">${r}</div>`}},Se=`
  :host { display: block; }
  * { box-sizing: border-box; }
...
`;function oe(){typeof customElements>"u"||(customElements.get("juiced-dashboard-quick-actions")||customElements.define("juiced-dashboard-quick-actions",q),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-quick-actions")||window.customCards.push({type:"juiced-dashboard-quick-actions",name:"Juiced Dashboard \u2014 Snelacties",description:"Een kleine, gecureerde rij kruis-kamer acties (alarm, garagepoort, ...).",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var Ct=typeof HTMLElement>"u"?class{}:HTMLElement;function Et(t,e){let i=[],r=u(t,e.temperature);if(r&&!g(r.state)){let n=h(r.state,1);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}</div><div class="jrd-tile-label">Temperatuur</div></div>`)}let o=u(t,e.humidity);if(o&&!g(o.state)){let n=y(o.state,0);n&&i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(n)}<span class="jrd-tile-unit">%</span></div><div class="jrd-tile-label">Vochtigheid</div></div>`)}let a=e.lights||[];if(a.length>0){let n=T(t,e);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${n}<span class="jrd-tile-unit">/${a.length}</span></div><div class="jrd-tile-label">Lampen aan</div></div>`)}if(e.climate){let n=u(t,e.climate);if(n&&!g(n.state)){let d=h(n.attributes?.temperature,1);i.push(`<div class="jrd-tile"><div class="jrd-tile-value">${s(k(n.state))}</div><div class="jrd-tile-label">Klimaat${d?` \xB7 doel ${s(d)}`:""}</div></div>`)}}return i.length?`<div class="jrd-overview">${i.join("")}</div>`:""}var U=class extends Ct{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-room-detail-card",room:{name:"Bureau",icon:"mdi:desk"}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-room-detail-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 5}connectedCallback(){this.root.addEventListener("click",this._onClick)}disconnectedCallback(){this.root.removeEventListener("click",this._onClick)}_render(){if(!this._config)return;let e=this._config.room,i=this._hass,r=Et(i,e),o=[B(i,e),N(i,e),_(i,e,"covers","Rolluiken"),_(i,e,"awnings","Luifels"),V(i,e)].filter(n=>!!n),a=r||o.length?`${r}${o.length?`<div class="jrd-sections">${o.join("")}</div>`:""}`:'<p class="jrd-empty">Geen bediening of sensoren geconfigureerd voor deze kamer.</p>';this.root.innerHTML=`
      <style>${Rt}</style>
      ...
      </ha-card>`}_onClick(e){let r=e.target?.closest("[data-action]");if(!r)return;let o=r.dataset.action,a=this._hass;if(o==="toggle-light"){H(a,r.dataset.entity);return}if(o==="cover-open"){D(a,r.dataset.entity);return}if(o==="cover-close"){M(a,r.dataset.entity);return}if(o==="cover-stop"){z(a,r.dataset.entity);return}if(o==="media-toggle"){J(a,r.dataset.entity);return}if(o==="climate-mode"){I(a,r.dataset.entity,r.dataset.mode);return}if(o==="climate-step"){O(a,r.dataset.entity,r.dataset.target,Number(r.dataset.step));return}}},Rt=`
  :host { display: block; }
  * { box-sizing: border-box; }
  ha-card.jrd-shell {
    background: var(--juiced-surface-raised, var(--ha-card-background, var(--card-background-color, #fff)));
...
`;function ae(){typeof customElements>"u"||(customElements.get("juiced-dashboard-room-detail-card")||customElements.define("juiced-dashboard-room-detail-card",U),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-room-detail-card")||window.customCards.push({type:"juiced-dashboard-room-detail-card",name:"Juiced Dashboard \u2014 Kamerdetail",description:"Volledige kamerpagina: overzicht, klimaat, verlichting, rolluiken/luifels en media.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var St=typeof HTMLElement>"u"?class{}:HTMLElement,$t={disarmed:"Uitgeschakeld",armed_home:"Ingeschakeld (thuis)",armed_away:"Ingeschakeld (afwezig)",armed_night:"Ingeschakeld (nacht)",arming:"Wordt ingeschakeld\u2026",pending:"In afwachting\u2026",triggered:"Alarm!"},Lt=6e3,G=class extends St{_config=null;_hass=null;_cameraIndex=0;_timer=null;constructor(){super(),this.attachShadow({mode:"open"}),this._onClick=this._onClick.bind(this)}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-security-card",security:{alarm_entity:"alarm_control_panel.huis",cameras:[]}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-security-card: invalid configuration.");this._config=e,this._cameraIndex=0,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 3}connectedCallback(){this.root.addEventListener("click",this._onClick),this._startTimer()}disconnectedCallback(){this.root.removeEventListener("click",this._onClick),this._stopTimer()}_startTimer(){this._stopTimer(),!((this._config?.security.cameras??[]).length<=1)&&(typeof window<"u"&&window.matchMedia?.("(prefers-reduced-motion: reduce)").matches||(this._timer=setInterval(()=>{let i=this._config?.security.cameras.length??0;i!==0&&(this._cameraIndex=(this._cameraIndex+1)%i,this._render())},Lt)))}_stopTimer(){this._timer!==null&&(clearInterval(this._timer),this._timer=null)}_onClick(e){let i=e.target?.closest("[data-action]");if(!i||!this._hass||!this._config)return;let r=i.dataset.action;if(r==="alarm"){let a=i.dataset.service,n=this._config.security.alarm_entity;a&&n&&this._hass.callService("alarm_control_panel",a,{entity_id:n});return}let o=this._config.security.cameras;if(r==="camera-select"){let a=Number(i.dataset.index);Number.isFinite(a)&&(this._cameraIndex=a,this._startTimer(),this._render());return}if(r==="camera-prev"||r==="camera-next"){if(o.length===0)return;let a=r==="camera-prev"?-1:1;this._cameraIndex=(this._cameraIndex+a+o.length)%o.length,this._startTimer(),this._render();return}if(r==="privacy-toggle"){let a=i.dataset.entity,n=i.dataset.service||"toggle";a&&this._hass.callService(a.split(".")[0]??"",n,{entity_id:a});return}}_render(){if(!this._config)return;let e=this._config.security,i=this._alarmHtml(e.alarm_entity),r=this._cameraHtml(e.cameras??[]);if(!i&&!r){this.root.innerHTML=`<style>${$e}</style>`;return}this.root.innerHTML=`<style>${$e}</style><ha-card class="jsc-shell">${i}${r}</ha-card>`}_alarmHtml(e){if(!e)return"";let i=u(this._hass,e);if(!i||g(i.state))return"";let r=$t[i.state]||i.state;return`
      <div class="jsc-alarm">
...
`;function ne(){typeof customElements>"u"||(customElements.get("juiced-dashboard-security-card")||customElements.define("juiced-dashboard-security-card",G),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-security-card")||window.customCards.push({type:"juiced-dashboard-security-card",name:"Juiced Dashboard \u2014 Security",description:"Alarmbediening en een doorbladerbare camerastrook, privacy enkel bij camera's die dat effectief hebben.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var At=typeof HTMLElement>"u"?class{}:HTMLElement,Tt=[{key:"battery_soc_entity",label:"Thuisbatterij SoC"},{key:"battery_charge_entity",label:"Batterij laden"},{key:"battery_discharge_entity",label:"Batterij ontladen"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst"},{key:"home_consumption_entity",label:"Huisverbruik"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek"}];function Ht(t,e){let r=u(t,e)?.attributes?.unit_of_measurement;return typeof r=="string"?r:""}function Dt(t){return{"clear-night":"Helder",cloudy:"Bewolkt",exceptional:"Uitzonderlijk",fog:"Mist",hail:"Hagel",lightning:"Onweer","lightning-rainy":"Onweer met regen",partlycloudy:"Half bewolkt",pouring:"Zware regen",rainy:"Regenachtig",snowy:"Sneeuw","snowy-rainy":"Natte sneeuw",sunny:"Zonnig",windy:"Winderig","windy-variant":"Winderig"}[t]||t}var Mt=["zo","ma","di","wo","do","vr","za"];function Le(t){let e=t.match(/^(\d{1,2})-(\d{1,2})-(\d{4})$/);if(e)return new Date(Number(e[3]),Number(e[2])-1,Number(e[1]));let i=t.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/);if(i)return new Date(Number(i[1]),Number(i[2])-1,Number(i[3]));let r=new Date(t);return Number.isNaN(r.getTime())?null:r}function Ae(t,e=new Date){let i=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return Math.round((r.getTime()-i.getTime())/864e5)}function Te(t){return t===0?"Vandaag":t===1?"Morgen":t>1?`Over ${t} dagen`:t===-1?"Gisteren":`${Math.abs(t)} dagen geleden`}var F=class extends At{_config=null;_hass=null;constructor(){super(),this.attachShadow({mode:"open"})}get root(){return this.shadowRoot}static getStubConfig(){return{type:"custom:juiced-dashboard-today-card",today:{weather_entity:"weather.thuis",waste_entities:[]}}}setConfig(e){if(!e||typeof e!="object")throw new Error("juiced-dashboard-today-card: invalid configuration.");this._config=e,this._render()}set hass(e){this._hass=e,this._render()}get hass(){return this._hass}getCardSize(){return 3}_render(){if(!this._config)return;let e=this._config.today??{waste_entities:[]},i=this._hass,r=this._weatherHtml(i,e.weather_entity),o=this._energyHtml(i,e),a=this._wasteHtml(i,e.waste_entities??[]);this.root.innerHTML=`
      <style>${zt}</style>
      ...
      <div class="jtc-weather">
        <div>
          <div class="jtc-weather-cond">${s(Dt(r.state))}</div>
          <div class="jtc-weather-loc">Thuis &middot; nu</div>
        </div>
        ${o?`<div class="jtc-weather-temp">${s(o)}</div>`:""}
      </div>`}_energyHtml(e,i){let r=Tt.map(o=>{let a=i[o.key],n=u(e,a);if(!a||!n||g(n.state))return"";let d=y(n.state,1);if(d===null)return"";let c=Ht(e,a);return`
        <div class="jtc-tile">
          <div class="jtc-tile-value">${s(d)}${c?` <span class="jtc-tile-unit">${s(c)}</span>`:""}</div>
          <div class="jtc-tile-label">${s(o.label)}</div>
        </div>`}).join("");return r?`<div class="jtc-energy">${r}</div>`:""}_wasteHtml(e,i){let r=i.map(o=>{let a=u(e,o);if(!a||g(a.state))return"";let n=a.attributes?.friendly_name,d=typeof n=="string"&&n?n:o,c=Le(a.state),l=c===null?`<span class="jtc-waste-wd">${s(a.state)}</span>`:`<span class="jtc-waste-day">${c.getDate()}</span><span class="jtc-waste-wd">${Mt[c.getDay()]}</span>`,m=c===null?"":Te(Ae(c));return`
...
`;function se(){typeof customElements>"u"||(customElements.get("juiced-dashboard-today-card")||customElements.define("juiced-dashboard-today-card",F),typeof window<"u"&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type==="juiced-dashboard-today-card")||window.customCards.push({type:"juiced-dashboard-today-card",name:"Juiced Dashboard \u2014 Vandaag",description:"Weer, energie-KPI's en afvalophaling in \xE9\xE9n rustige kaart.",preview:!1,documentationURL:"https://github.com/ju1ced/juiced-dashboard"})))}var It=typeof HTMLElement>"u"?class{}:HTMLElement;function de(t,e){return{type:"markdown",...e?{title:e}:{},content:t}}var He="Kamers",Ot="Tik een kamer om lichten, rolluiken, luifels, radio of airco direct te bedienen";function Jt(t){return t?!!(t.weather_entity||t.battery_soc_entity||t.battery_charge_entity||t.battery_discharge_entity||t.solar_power_entity||t.home_consumption_entity||t.monthly_peak_entity||(t.waste_entities??[]).length>0):!1}function Nt(t){if(!(!t||t.length===0))return{type:"grid",cards:[{type:"custom:juiced-dashboard-quick-actions",actions:t}]}}function Vt(t){return t?!!(t.alarm_entity||(t.cameras??[]).length>0):!1}function Bt(t,e){let i=[];if(Jt(t)&&i.push({type:"custom:juiced-dashboard-today-card",today:t}),Vt(e)&&i.push({type:"custom:juiced-dashboard-security-card",security:e}),i.length!==0)return i.length===1?{type:"grid",cards:i}:{type:"grid",cards:[{type:"grid",columns:2,square:!1,cards:i}]}}function De(t){return t.length===0?{type:"grid",cards:[de("Voeg kamers toe via **Dashboard bewerken \u2192 instellingen**.",He)]}:{type:"grid",cards:[{type:"custom:juiced-dashboard-room-card",title:He,subtitle:Ot,rooms:t.map(K)}]}}function Kt(t){let e=t?.person_entities??[];if(e.length)return e.map(i=>({type:"entity",entity:i,show_name:!0}))}function Pt(t){return t?[{type:"grid",cards:[{type:"custom:juiced-dashboard-room-detail-card",room:K(t)}]}]:[{type:"grid",cards:[de("Deze kamerconfiguratie ontbreekt.","Kamer")]}]}function ce(t,e){return[{type:"grid",cards:[de(e,t)]}]}function Me(t){let e;switch(t.view){case"home":e=[Bt(t.today,t.security),Nt(t.quick_actions),De(t.rooms??[])].filter(r=>!!r);break;case"rooms":e=[De(t.rooms??[])];break;case"room":e=Pt(t.room);break;case"energy":e=ce("Energie","Energie-overzicht volgt in een volgende stap.");break;case"domains":e=ce("Domeinen","Specialistische domeinen (Kia, tuin, robotstofzuiger, zwembad) volgen in een volgende stap.");break;default:e=ce("Meer","Instellingen en geschiedenis volgen in een volgende stap.");break}let i=t.view==="home"?Kt(t.general):void 0;return{type:"sections",max_columns:1,dense_section_placement:!0,sections:e,...i?{badges:i}:{}}}var Q=class extends It{static async generate(e){return Me(e)}};function le(){if(se(),oe(),ne(),ae(),typeof customElements>"u")return;let t="ll-strategy-view-juiced-dashboard-view";customElements.get(t)||customElements.define(t,Q)}var qt={buiten:"Buiten",gelijkvloers:"Gelijkvloers",boven:"Boven"},Ut=typeof HTMLElement>"u"?class{}:HTMLElement,ue=[{key:"temperature_entity",label:"Temperatuursensor",domain:"sensor"},{key:"humidity_entity",label:"Vochtigheidssensor",domain:"sensor"},{key:"light_entities",label:"Lichten",domain:"light",multiple:!0},{key:"cover_entities",label:"Rolluiken",domain:"cover",multiple:!0},{key:"awning_entities",label:"Luifels",domain:"cover",multiple:!0},{key:"media_player_entity",label:"Mediaspeler",domain:"media_player"},{key:"climate_entity",label:"Klimaat",domain:"climate"}],ze=0,Ie=0,Oe=0,Je=[{key:"weather_entity",label:"Weerbron",domain:"weather"},{key:"battery_soc_entity",label:"Thuisbatterij SoC",domain:"sensor"},{key:"battery_charge_entity",label:"Batterij laden",domain:"sensor"},{key:"battery_discharge_entity",label:"Batterij ontladen",domain:"sensor"},{key:"solar_power_entity",label:"Zonnepanelen opbrengst",domain:"sensor"},{key:"home_consumption_entity",label:"Huisverbruik",domain:"sensor"},{key:"monthly_peak_entity",label:"Maandelijkse vermogenspiek",domain:"sensor"}];function f(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var W=class extends Ut{_config;_hass=null;constructor(){super(),this.attachShadow({mode:"open"}),this._config=j(void 0),this._onInput=this._onInput.bind(this),this._onClick=this._onClick.bind(this),this._onSelectorChange=this._onSelectorChange.bind(this)}get root(){return this.shadowRoot}setConfig(e){this._config=j(e),this._render()}set hass(e){this._hass=e,this.root.querySelectorAll("ha-selector").forEach(i=>{i.hass=e})}get hass(){return this._hass}connectedCallback(){this.root.addEventListener("input",this._onInput),this.root.addEventListener("click",this._onClick),this.root.addEventListener("value-changed",this._onSelectorChange)}disconnectedCallback(){this.root.removeEventListener("input",this._onInput),this.root.removeEventListener("click",this._onClick),this.root.removeEventListener("value-changed",this._onSelectorChange)}_emit(){this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:this._config}}))}_updateGeneral(e,i){this._config={...this._config,general:{...this._config.general,[e]:i}},this._emit()}_updateRoom(e,i){this._config={...this._config,rooms:this._config.rooms.map(r=>r.key===e?{...r,...i}:r)},this._emit()}_addRoom(){ze+=1;let e={key:`room-${Date.now().toString(36)}-${ze}`,name:"Nieuwe kamer",light_entities:[],cover_entities:[],awning_entities:[]};this._config={...this._config,rooms:[...this._config.rooms,e]},this._emit(),this._render()}_removeRoom(e){this._config={...this._config,rooms:this._config.rooms.filter(i=>i.key!==e)},this._emit(),this._render()}_updateToday(e){this._config={...this._config,today:{...this._config.today,...e}},this._emit()}_updateAction(e,i){this._config={...this._config,quick_actions:this._config.quick_actions.map(r=>r.key===e?{...r,...i}:r)},this._emit()}_addAction(){Ie+=1;let e={key:`action-${Date.now().toString(36)}-${Ie}`,label:"Nieuwe actie",entity:"",service:"toggle"};this._config={...this._config,quick_actions:[...this._config.quick_actions,e]},this._emit(),this._render()}_removeAction(e){this._config={...this._config,quick_actions:this._config.quick_actions.filter(i=>i.key!==e)},this._emit(),this._render()}_updateSecurity(e){this._config={...this._config,security:{...this._config.security,...e}},this._emit()}_updateCamera(e,i){this._config={...this._config,security:{...this._config.security,cameras:this._config.security.cameras.map(r=>r.key===e?{...r,...i}:r)}},this._emit()}_addCamera(){Oe+=1;let e={key:`camera-${Date.now().toString(36)}-${Oe}`,name:"Nieuwe camera",camera_entity:""};this._config={...this._config,security:{...this._config.security,cameras:[...this._config.security.cameras,e]}},this._emit(),this._render()}_removeCamera(e){this._config={...this._config,security:{...this._config.security,cameras:this._config.security.cameras.filter(i=>i.key!==e)}},this._emit(),this._render()}_onInput(e){let i=e.target;if(!i)return;let r=i.dataset.field;if(!r)return;if(i.dataset.scope==="general"){r==="title"&&this._updateGeneral("title",i.value),r==="start_view"&&this._updateGeneral("start_view",i.value),r==="theme_mode"&&this._updateGeneral("theme_mode",i.value);return}if(i.dataset.scope==="action"){let a=i.dataset.actionKey;if(!a)return;r==="label"&&this._updateAction(a,{label:i.value}),r==="icon"&&this._updateAction(a,{icon:i.value||void 0}),r==="service"&&this._updateAction(a,{service:i.value});return}if(i.dataset.scope==="camera"){let a=i.dataset.cameraKey;if(!a)return;r==="name"&&this._updateCamera(a,{name:i.value}),r==="privacy_service"&&this._updateCamera(a,{privacy_service:i.value||void 0});return}let o=i.dataset.room;o&&(r==="name"&&this._updateRoom(o,{name:i.value}),r==="icon"&&this._updateRoom(o,{icon:i.value||void 0}),r==="zone"&&this._updateRoom(o,{zone:i.value||void 0}))}_onSelectorChange(e){let i=e.target;if(!i||i.tagName.toLowerCase()!=="ha-selector")return;e.stopPropagation();let r=i.dataset.field,o=i.dataset.scope;if(!r)return;if(o==="general"){if(r==="person_entities"){let c=Array.isArray(e.detail?.value)?e.detail.value.filter(l=>typeof l=="string"):[];this._updateGeneral("person_entities",c)}return}if(o==="today"){if(r==="waste_entities"){let l=Array.isArray(e.detail?.value)?e.detail.value.filter(m=>typeof m=="string"):[];this._updateToday({waste_entities:l});return}let c=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateToday({[r]:c});return}if(o==="action"){let c=i.dataset.actionKey;if(!c)return;let l=typeof e.detail?.value=="string"?e.detail.value:"";this._updateAction(c,{entity:l});return}if(o==="security"){let c=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateSecurity({alarm_entity:c});return}if(o==="camera"){let c=i.dataset.cameraKey;if(!c)return;let l=typeof e.detail?.value=="string"?e.detail.value:void 0;r==="camera_entity"&&this._updateCamera(c,{camera_entity:l??""}),r==="privacy_entity"&&this._updateCamera(c,{privacy_entity:l});return}let a=i.dataset.room;if(!a)return;if(ue.find(c=>c.key===r)?.multiple){let c=Array.isArray(e.detail?.value)?e.detail.value.filter(l=>typeof l=="string"):[];this._updateRoom(a,{[r]:c});return}let d=typeof e.detail?.value=="string"?e.detail.value:void 0;this._updateRoom(a,{[r]:d})}_onClick(e){let i=e.target?.closest("[data-action]");i&&(i.dataset.action==="add-room"&&this._addRoom(),i.dataset.action==="remove-room"&&i.dataset.room&&this._removeRoom(i.dataset.room),i.dataset.action==="add-action"&&this._addAction(),i.dataset.action==="remove-action"&&i.dataset.actionKey&&this._removeAction(i.dataset.actionKey),i.dataset.action==="add-camera"&&this._addCamera(),i.dataset.action==="remove-camera"&&i.dataset.cameraKey&&this._removeCamera(i.dataset.cameraKey))}_render(){let e=this._config;this.root.innerHTML=`
      <style>${Gt}</style>
      ...
      <div class="jde-room">
        ...
        <label>Zone
          <select data-room="${e.key}" data-field="zone">
            ...
            ${S.map(i=>`<option value="${i}" ${e.zone===i?"selected":""}>${f(qt[i])}</option>`).join("")}
          </select>
        </label>
        ${ue.map(i=>`
          <label>${f(i.label)}
...
`;function pe(){typeof customElements>"u"||customElements.get("juiced-dashboard-strategy-editor")||customElements.define("juiced-dashboard-strategy-editor",W)}var Ne=Object.freeze({name:"Juiced Dashboard",version:"0.1.0"});typeof window<"u"&&(Y(),pe(),le(),re(),window.__JUICED_DASHBOARD_BUILD__=Ne,console.info("%c JUICED DASHBOARD %c "+Ne.version,"color: #081018; background: #5cc8ff; font-weight: 700; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #5cc8ff; background: #0f1115; font-weight: 700; padding: 2px 6px; border-radius: 0 4px 4px 0;"));export{R as CONFIG_SCHEMA_VERSION,we as DEFAULT_CLIMATE_TARGET,q as JuicedDashboardQuickActions,A as JuicedDashboardRoomCard,U as JuicedDashboardRoomDetailCard,G as JuicedDashboardSecurityCard,P as JuicedDashboardStrategy,W as JuicedDashboardStrategyEditor,F as JuicedDashboardTodayCard,Q as JuicedDashboardViewStrategy,S as ROOM_ZONES,ee as START_VIEWS,te as THEME_MODES,X as VIEW_PATHS,Ne as buildInfo,Me as buildView,M as closeCover,xe as collectEntityIds,j as compileConfig,K as compileRoomForCard,ye as coverPosition,ve as coverPositionLabel,ie as createDefaultConfig,Ae as daysUntil,E as displayName,u as entityState,s as escapeHtml,y as formatNumber,h as formatTemp,_e as hasRelevantChange,he as humanize,k as hvacModeLabel,g as isUnavailable,D as openCover,Le as parseWasteDate,pe as registerJuicedDashboardEditor,oe as registerJuicedDashboardQuickActions,Y as registerJuicedDashboardRoomCard,ae as registerJuicedDashboardRoomDetailCard,ne as registerJuicedDashboardSecurityCard,re as registerJuicedDashboardStrategy,se as registerJuicedDashboardTodayCard,le as registerJuicedDashboardViewStrategy,Te as relativeWasteLabel,be as roomEntityIds,je as roomFlag,Pe as roomHasControls,C as roomIconSvg,T as roomLightsOn,Re as roomPath,B as roomSectionClimate,_ as roomSectionCovers,N as roomSectionLights,V as roomSectionMedia,Z as roomStatLine,I as setHvacMode,O as stepClimateTarget,z as stopCover,H as toggleLight,J as toggleMediaPlayPause};
